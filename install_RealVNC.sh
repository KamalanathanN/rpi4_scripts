...
# Script that will install RealVNC on Raspberry Pi 4B 4gb with Ubuntu Mate 20.04 64bit
# Based on instructions from https://www.raspberrypi.org/forums/viewtopic.php?t=288769


#update below based on version
vncServer="realvnc-vnc-server_6.7.2.43081_arm64.deb"


echo "You are about to install RealVNC Server for RaspberryPi4 4gb"
echo $vncServer
echo "Running OS Ubuntu Mate 20.04 64bit"
echo
echo
